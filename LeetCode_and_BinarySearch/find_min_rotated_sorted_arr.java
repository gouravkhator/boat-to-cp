class FindMinRotatedSortedArr {
    ...
    public static int findMin(int[] nums) {
        ...
        Find the pivot point where the array might be rotated.
        And then the minimum will be the element in the start of the second subarray, which is after the pivot.
        
        This approach takes into account finding pivot point, which can be checked from problem sum: 
        "Seach in rotated sorted array: https://leetcode.com/problems/search-in-rotated-sorted-array/"
        */
